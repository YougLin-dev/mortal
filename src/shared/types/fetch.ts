export const FETCH_REQUEST_CHANNEL = 'ipc-fetch:request';
export const FETCH_RESPONSE_CHANNEL = 'ipc-fetch:response';
...
export const FETCH_STREAM_READY_CHANNEL = 'ipc-fetch:stream-ready';
